...
\acmConference[I3D’19]{ACM SIGGRAPH Symposium on
Interactive 3D Graphics and Games}{May 05--07, 2020}{San Francisco, USA}
...
\keywords{unified data structure, simulation problem, interrelated problems set, unified algorithmic environment, concatenable queue}
...
\bibliography{article-acm-siggraph}
