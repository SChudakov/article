...
%	\end{itemize}
	...
	%The algorithm of inserting an element in a queue is described on the Listing \ref{lst:insert-alg}.
...
%	Its algorithm is described on the Listing \ref{lst:split-alg}.
